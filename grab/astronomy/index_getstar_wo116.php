...
set_time_limit(0);
$path = '/data/grab/data/wo116xingzuo/';
...
{
	$style = array('1' => '14px', '2' => '28px', '3' => '42px','4'=> '56px', '5' => '70px');
	$html = '
			<div id=xz-c class="a-c box-c">
			<div class=xc-s>
			<a class=xc-pic href=http://yuncheng.wo116.com/'.$key.'.htm><img src=http://i.9533.com/style/images/sx'.$key.'.gif></a>
	...
	$html .= '
	<ul class=xc-zs><li style=width:50%>健康指数：<em>'.$info['content']['4']['content'].'</em></li><li>商谈指数：<em>'.$info['content']['5']['content'].'</em></li><li style=width:50%>幸运颜色：<em>'.$info['content']['6']['content'].'</em></li><li>幸运数字：<em>'.$info['content']['7']['content'].'</em></li></ul>
	<p class=xc-yc><a href=http://yuncheng.wo116.com/'.$key.'.htm >&nbsp;&nbsp;&nbsp;&nbsp;'.sub_str($info['comment'], 77).'</a></p><a class=xc-more href=http://yuncheng.wo116.com/'.$key.'.htm >更多»</a>
	</div>';
	return $html;
}
